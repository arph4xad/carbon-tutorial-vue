        ...
        <div class="bx--col bx--no-gutter">
            <cv-tabs selected="0" aria-label="Tab navigation">
                    ...
                    <div class="bx--grid bx--grid--full-width bx--grid--no-gutter">
                        <div class="bx--row landing-page__tab-content">
                            <div class="bx--col-md-4 bx--col-lg-7">
                                ...
                                <p class="landing-page__p">Carbon is IBM’s open-source design system for digital products and experiences. With the IBM Design Language as its foundation, the system consists of working code, design tools and resources, human interface guidelines, and a vibrant community of contributors.</p>
                ...
                <cv-tab label="Design">
                    <div class="bx--grid bx--grid--full-width bx--grid--no-gutter">
                        <div class="bx--row landing-page__tab-content">
                            <div class="bx--col-lg-16">Rapidly build beautiful and accessible experiences. The Carbon kit contains all resources you need to get started.</div>
                        </div>
                    </div>
                </cv-tab>
                <cv-tab label="Develop">
                    <div class="bx--grid bx--grid--full-width bx--grid--no-gutter">
                        <div class="bx--row landing-page__tab-content">
                            <div class="bx--col-lg-16">Carbon provides styles and components in Vanilla, React, Angular, and Vue for anyone building on the web.</div>
                        </div>
                    </div>
                </cv-tab>
            </cv-tabs>
